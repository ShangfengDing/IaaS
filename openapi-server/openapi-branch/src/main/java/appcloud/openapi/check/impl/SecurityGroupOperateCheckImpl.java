...
public class SecurityGroupOperateCheckImpl implements SecurityGroupOperateCheck{
	...
	public Map<String, String> checkDelete(Map<String, String> paramsMap)
		...
		try {
			SecurityGroupChecker.checkOwnerByUuid(userId,paramsMap.get(Constants.SECURITY_GROUP_ID), false);
		}catch (Exception e) {
	...
	public Map<String, String> checkRevoke(Map<String, String> paramsMap)
		...
		VmSecurityGroup vmSecurityGroup = null;
		try {
			vmSecurityGroup = SecurityGroupChecker.checkOwnerByUuid(userId, paramsMap.get(Constants.SECURITY_GROUP_ID), false);
		}catch (Exception e) {
			return commonGenerator.operationDeny(e.getMessage(), null);
		}
		...
		if(paramsMap.get(Constants.SECURITY_GROUP_ID) != null) {
			query.addFilterBean(new FilterBean<VmSecurityGroupRule>("groupId", vmSecurityGroup.getId(), FilterBeanType.EQUAL));
		}
