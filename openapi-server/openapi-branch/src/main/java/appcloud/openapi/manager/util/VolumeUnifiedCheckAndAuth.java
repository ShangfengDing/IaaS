	...
	public  Map<String, String> checkAndAuth (Map<String, String> paramsMap, final Map<String, String> defaultParamsMap) {
		...
		try {
			...
			case ActionConstants.CREATE_DISK:
				...
				break;
			case ActionConstants.CREATE_DISK_IMAGEBACK:
				resultMap = volumeParamsCheck.checkCreateDiskImageBackParams(paramsMap);
				break;
			...
			case ActionConstants.DESCRIBE_DISKS:
				...
				break;
			case ActionConstants.DESCRIBE_DISK_IMAGEBACK:
				resultMap = volumeParamsCheck.checkDescribeImageBackParams(paramsMap);
				break;
			case ActionConstants.RESET_DISK:
				resultMap = volumeParamsCheck.checkResetParams(paramsMap);
				break;
			case ActionConstants.MODIFY_DISK_ATTRIBUTE:
				resultMap = volumeParamsCheck.checkModifyAttributesParams(paramsMap);
				break;
			case ActionConstants.MODIFY_DISK_IMAGEBACK:
				resultMap = volumeParamsCheck.checkModifyAttributesParams(paramsMap);
				break;
			case ActionConstants.RENEW_DISK:
				resultMap = volumeParamsCheck.checkRenewDiskParams(paramsMap);
				break;
			default :
				resultMap = null;
				break;
			...
			case ActionConstants.CREATE_DISK:
				...
				break;
			case ActionConstants.CREATE_DISK_IMAGEBACK:
				resultMap = volumeOperateCheck.checkCreateDiskImageBack(paramsMap);
				break;
			case ActionConstants.ATTACH_DISK:
			...
			case ActionConstants.DESCRIBE_DISKS:
				...
				break;
			case ActionConstants.DESCRIBE_DISK_IMAGEBACK:
				resultMap = volumeOperateCheck.checkDescribeImageBackParams(paramsMap);
				break;
			case ActionConstants.RESET_DISK:
				resultMap = volumeOperateCheck.checkResetParams(paramsMap);
				break;
			case ActionConstants.MODIFY_DISK_ATTRIBUTE:
				resultMap = volumeOperateCheck.checkModifyAttributesParams(paramsMap);
				break;
			case ActionConstants.MODIFY_DISK_IMAGEBACK:
				resultMap = volumeOperateCheck.checkModifyAttributesParams(paramsMap);
				break;
			case ActionConstants.RENEW_DISK:
				resultMap = volumeOperateCheck.checkRenewDisk(paramsMap);
				break;
			default :
				resultMap = null;
				break;
