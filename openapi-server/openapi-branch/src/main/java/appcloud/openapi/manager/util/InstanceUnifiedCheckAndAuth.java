	...
	public Map<String, String> InstanceCheckAndAuth(Map<String, String> paramsMap, Map<String, String> defaultParamsMap) {
		...
		try {
			...
			case ActionConstants.CREATE_INSTANCE :
				...
				break;
			case ActionConstants.RECOVERY_INSTANCE :
				resultMap = instanceParamsCheck.checkRecoveryParams(paramsMap);
				break;
			...
			case ActionConstants.CREATE_INSTANCE :
				...
				break;
			case ActionConstants.RECOVERY_INSTANCE :
				resultMap = instanceOperateCheck.checkRecoveryInstance(paramsMap);
				break;
			case ActionConstants.START_INSTANCE :
