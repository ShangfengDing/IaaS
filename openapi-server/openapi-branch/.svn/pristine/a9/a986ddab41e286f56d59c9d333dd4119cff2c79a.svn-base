...
public interface InstanceParamsCheck {
	...
	/**
	 * 开放API检查查看云服务器实例的监控信息接口自身参数
	 * @param paramsMap
	 * @return
	 * @throws Exception
	 */
	public Map<String, String> checkMonitorParams(Map<String, String> paramsMap) throws Exception;
	/**
	 * 开放API检查迁移实例接口自身参数
	 * @param paramsMap
	 * @return
	 * @throws Exception
	 */
	public Map<String, String> checkMigrateParams(Map<String, String> paramsMap) throws Exception;
	/**
	 * 开放API检查在线迁移实例接口自身参数
	 * @param paramsMap
	 * @return
	 * @throws Exception
	 */
	public Map<String, String> checkOnlineMigrateParams(Map<String, String> paramsMap) throws Exception;
	/**
	 * 开放API检查挂起实例接口自身参数
	 * @param paramsMap
	 * @return
	 * @throws Exception
	 */
	public Map<String, String> checkSuspendParams(Map<String, String> paramsMap) throws Exception;
	/**
	 * 开放API检查恢复迁移实例接口自身参数
	 * @param paramsMap
	 * @return
	 * @throws Exception
	 */
	public Map<String, String> checkResumeParams(Map<String, String> paramsMap) throws Exception;
	 ...
	 * @return
	 */
	public Map<String, String> checkRenewInstanceParams(Map<String, String> paramsMap) throws Exception;
}
