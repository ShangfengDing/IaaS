        ...
        try {
            ...
            switch(paramsMap.get(Constants.ACTION)) {
                case ActionConstants.CREATE_IMAGE :
                    ...
                    break;
                case ActionConstants.AUTHORIZE_IMAGE :
                    resultMap = imageParamsCheck.checkAuthorizeParams(paramsMap);
                    break;
           ...
           //签名认证
            ...
            switch(paramsMap.get(Constants.ACTION)) {
                case ActionConstants.CREATE_IMAGE :
                    ...
                    break;
                case ActionConstants.AUTHORIZE_IMAGE :
                    resultMap = imageOperateCheck.checkAuthorizeImage(paramsMap);
                    break;
                case ActionConstants.DELETE_IMAGE :
