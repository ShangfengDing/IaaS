...
public class FileUtil {
     ...
     * 获得指定数目的日志, 注意是倒着读取
     */
    public static List<String> getReverseFileLines(String filePath, Integer num) {
        return IoHelper.getReverseFileLines(filePath, num);
    }
     ...
     * @return
     */
    public static String getDestFilePath(String destIp, String sourceFilePath) {
        String destFilePath = sourceFilePath.replaceAll("([0-9]{3}\\.)([0-9]{3}\\.)([0-9]+\\.)[0-9]+",destIp);
        return destFilePath;
    }

    @Deprecated
    public static String getTestFilePath() {
        return "D:\\data\\test\\bitcoin-on-nodejs.pdf";
    }
