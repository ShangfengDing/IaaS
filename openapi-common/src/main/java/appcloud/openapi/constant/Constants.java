...
public class Constants {
	...
	public final static String HOST_MAC = "HostMac";

	// 用户相关的接口参数
	public final static String PRE_USER_ID = "PreUserId";
	public final static String NEW_USER_EMAIL = "NewUserEmail";
	public final static String GROUP_SECRET_KEY = "GroupSecretKey";
	...
	public final static String IMAGEBACK_ID = "ImageBackId";
	...
	public final static String VM_MAC_PRI = "PriVmMac";
	public final static String VM_MAC_PUB = "PubVmMac";
	...
	public final static String INSTANCE_IDS = "InstanceIds";
	public final static String HOST_ID = "HostId";
	public final static String DATA_CENTER_ID = "DataCenterId";
	...
	public final static String INNER_IP_ADDRESSES = "InnerIpAddresses";
	public final static String PUBLIC_IP_ADDRESSES = "PublicIpAddresses";
	public final static String INSTANCE_STATUS = "Status";
	//物理机接口的参数名称
	public final static String HOST_STATUS = "HostStatus";
	public final static String HOST_TYPE = "HostType";
	public final static String HOST_UUID = "HostUuid";
	...
	public final static String HOST_IDS = "HostUuids";
    ...
    public final static String ACTIVE_VOLUME_ID = "ActiveVolumeId";
    public final static String DISPLAY_NAME = "ImageName";
    public final static String SOFTWARE = "Software";
    public final static String ACCOUNT = "Account";
    public final static String DISPLAY_DESCRIPTION = "Description";
    public final static String GROUP_ID_LIST = "GroupIdList";
    public final static String DISTRIBUTION = "Distribution";
    public final static String IMAGE_UUID = "ImageId";
    public final static String GROUP_ID = "GroupId";
    public final static String IMAGE_TYPE = "ImageType";
    public final static String IMAGE_TYPE_IMAGE = "image";
    public final static String IMAGE_TYPE_ISO = "iso";
	public final static String IMAGE_NAME = "ImageName";
	public final static String IMAGE_STATUS = "Status";
	public final static String TYPE = "Type";
	public final static String IMAGE_ALL = "ALL";
	public final static String IMAGE_PUBLIC = "PUBLIC";
	public final static String IMAGE_GROUP = "GROUP";
	public final static String IMAGE_PRIVATE = "PRIVATE";
	...
	public final static String DISK_CHARGE_TYPE = "DiskChargeType";
	public final static String DISK_CHARGE_LENGTH = "DiskChargeLength";
	public final static String DISK_IDS = "DiskIds";
	public final static String DISK_STATUS = "Status";
	public final static String VOLUME_TYPE = "VolumeType";
	public final static String VOLUME_USAGE_TYPE = "VolumeUsageType";
	public final static String IMAGEBACK_STATUS = "ImageBackStatus";
	public final static String DISK_ATTACH_STATUS = "DiskAttachStatus";
	public final static String IS_BACK_UP = "IsBackUp";
	...
	//billing相关接口的参数名称
	public final static String INSTANCE_TYPES = "InstanceTypes";
	public final static String BALANCE_UNSATIFY = "balanceUnsatify";
	public final static String BILLING_OPERATION_SUCCESS = "success";
	//接口返回错误类型
	...
	public final static Integer MAX_DESCRIPTION = 200;
	...
	public final static Integer DEFAULT_ADMIN_PAGE_SIZE = 1000; //分页查询是设置的每页行数的默认值为10

	// 群组的相关默认参数
	public final static Integer MAX_NUMBER_OF_INSTANCE = 11;
	public final static Integer MAX_NUMBER_OF_DISK = 11;
	public final static Integer MAX_NUMBER_OF_BACKUP = 11;
	public final static Integer MAX_NUMBER_OF_SNAPSHOT = 11;
	public final static boolean SELECT_CLUSTER = true;
	public final static boolean PUBLISH_IMAGE = true;
	...
	public final static Integer MAX_PAY_BY_YEAR = 5;
	...
	//操作日志相关参数名称
	public final static String LOG_RESULT = "result";
	public final static String LOG_APPKEYID = "appkeyId";
	public final static String LOG_USERID = "userId";
	public final static String LOG_DEVICE = "device";
	public final static String LOG_PROVIDER = "provider";
	public final static String LOG_OPERATETYPE = "operateType";
	public final static String LOG_DEVICEID = "deviceId";
	public final static String LOG_INFOTYPE = "infoType";
	public final static String LOG_CREATEDTIME = "createdTime";
	public final static String SIZE = "size";
	public final static String ENDTIME = "etime";
	public final static String BEGINTIME = "btime";
	public final static String TIMEASC = "timeasc";
	...
	static {
		...
		try {
			...
			p.load(Constants.class.getClassLoader().getResourceAsStream("app.properties"));
