    ...
    <div class="container">
        <div class="col-md-12 form-group" style="margin-bottom:0px" >
            ...
            <div class="form-group pull-right" style="margin-bottom:0px" >
                ...
                <a href="runtime/preAddAdmin" rel="facebox" title="添加管理员"  class="btn btn-primary pull-right">新建</a>
            ...
            <%--<div class="front-toolbar other">
                ...
                <a href="runtime/preAddAdmin" rel="facebox" title="添加管理员"  class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;新建管理员</a>
            </div>--%>
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control front-no-box-shadow" id="adminname"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-1 control-label front-label"style="text-align:center;">邮箱</label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control front-no-box-shadow" id="adminemail"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="text-right col-md-12">
                                    <a href="javascript:void(0)"id="admin_manage_button2" class="btn btn-default" onclick="cancelSearch()">取消</a>
                                    <button type="button" id="admin_manage_button1" class="btn btn-primary" onclick="submitSearch(1)">查询</button>

                                   <%-- <a href="runtime/preAddAdmin" rel="facebox" title="添加管理员" class="btn btn-primary">添加管理员</a>--%>
                                </div>
                            </div>
                        </div>
                    </div>
