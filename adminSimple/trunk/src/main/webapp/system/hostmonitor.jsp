...
<div class="panel panel-default front-panel" style="margin-top:10px">
    <table class="table table-striped multi-table">
        <td class="centeralign" width="33%">
            <div>CPU使用率(%)<br/>
                <div id="cpuhighcharts"></div>
            </div>
        </td>
        <td class="centeralign" width="33%">
            <div>内存占用率(%)<br/>
                <div id="memhighcharts"></div>
            </div>
        </td>
        <td class="centeralign" width="34%">
            <div>硬盘占用率(%)<br/>
                <div id="diskhighcharts"></div>
            </div>
        </td>
        </tr>
        <tr>
            <td class="centeralign" width="33%">
                <div>平均负载<br/>
                    <div id="loadhighcharts"></div>
                </div>
            </td>
            <td class="centeralign" width="33%">
                <div>磁盘读写(MB/s)<br/>
                    <div id="iohighcharts"></div>
                </div>
            </td>
            <td class="centeralign" width="34%">
                <div>网络收发(MB/S)<br/>
                    <div id="nethighcharts"></div>
                </div>
            </td>
        </tr>
    </table>
