...
ARCHIVE_URL='http://hudson.free4lab.com/job/appcloud-dbproxy-trunk/lastSuccessfulBuild/artifact/target/*zip*/target.zip'
SNAPSHOT_NAME='dbproxy-0.0.1-SNAPSHOT.jar'
RUN_NAME='dbproxy.jar'
