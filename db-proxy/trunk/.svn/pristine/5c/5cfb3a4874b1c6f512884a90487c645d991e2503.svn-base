...
@Table(name = "vm_daily_load")
public class VmDailyLoadTable extends VmLoad {

    public VmDailyLoadTable() {
        super();
    }

    public VmDailyLoadTable(HostLoad hostLoad) {
