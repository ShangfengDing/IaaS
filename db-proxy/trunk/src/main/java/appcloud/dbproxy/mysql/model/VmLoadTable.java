...
@Entity
@Table(name = "vm_load")
public class VmLoadTable extends VmLoad{
    public VmLoadTable() {
        super();
    }
    public VmLoadTable(HostLoad vmLoad) {
	...
	public VmLoadTable(Double cpuPercent, Double avgLoad, Double memPercent,
			Double diskPercent, Double netInPercent, Double netOutPercent,
			Double diskReadRate, Double diskWriteRate) {
		setCpuPercent(cpuPercent.floatValue());
		setAvgLoad(avgLoad.floatValue());
		setMemPercent(memPercent.floatValue());
		setDiskPercent(diskPercent.floatValue());
		setNetInPercent(netInPercent.floatValue());
		setNetOutPercent(netOutPercent.floatValue());
		setDiskReadRate(diskReadRate.floatValue());
		setDiskWriteRate(diskWriteRate.floatValue());
	}
