...
//	public static final String CSS_JS_SERVER;
	...
	public static final String NEWFRONT_URL;
	/**
	 * host的类型
	 */
	public static final String HOST_TYPE = "COMPUTE_NODE";

	public static final String HBASE_TABLENAME;
...
//			Log.info("CSS_JS_SERVER:" + CSS_JS_SERVER);
			...
			NEWFRONT_URL = p.getProperty("NEWFRONT_URL");
			Log.info("NEWFRONT_URL:" + NEWFRONT_URL);

			HBASE_TABLENAME = p.getProperty("HBASE_TABLENAME");
			Log.info("HBASE_TABLENAME:" + HBASE_TABLENAME);
