...
public class AppkeyManager {
	...
	public List<Appkey> getAppkeyByEmailAndProvider(String email, String provider) {
		Map<String, Object> searchMap = new HashMap();
		searchMap.put("userEmail", email);
		searchMap.put("provider", provider);
		searchMap.put("state", 1);
		List<Appkey> appkeys = dao.findByProperty(searchMap, null, null, null, true);
		return appkeys;
	}

	public List<Appkey> getAppkeyByEmailAndZone(String email, String regionId, String zoneId) {
		Map<String, Object> searchMap = new HashMap();
		searchMap.put("userEmail", email);
		searchMap.put("region", regionId);
		searchMap.put("zone", zoneId);
		searchMap.put("state", 1);
		List<Appkey> appkeys = dao.findByProperty(searchMap, null, null, null, true);
		return appkeys;
	}
