...
//	private static volatile TipRPCClient mClientVMSUM;
	...
	private static volatile TipRPCClient tipClientSMP;
	public static volatile ServiceMonitorProxy serviceMonitorProxy;
	...
	public static ServiceMonitorProxy getServiceMonitorProxy() {
		if (serviceMonitorProxy == null) {
			synchronized (ConnectionFactory.class) {
				if (serviceMonitorProxy == null) {
					tipClientSMP = new TipRPCClient(
							ConnectionConfigs.DB_PROXY_ADDRESS,
							ConnectionConfigs.TIME_OUT);
					serviceMonitorProxy = (ServiceMonitorProxy) tipClientSMP
							.createProxy(ServiceMonitorProxy.class);
				}
			}
		}
		return serviceMonitorProxy;
	}
