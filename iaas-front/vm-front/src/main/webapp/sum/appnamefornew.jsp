    ...
    function sumNewApply() {
        ...
        if (newtype == 'vm') {
            switch (newProviderEn) {
                case "yunhai":
                    window.location.href='vm/newvm/newyunhaivm.jsp?appname=' + newAppname;
                    break;
                case "aliyun":
                    window.location.href='vm/newvm/aliyun/newaliyunvm.jsp?appname=' + newAppname;
            }
        } else if (newtype == 'hd') {
            switch (newProviderEn) {
                case "yunhai":
                    window.location.href='hd/newhd.jsp?menu=newhd&appname=' + newAppname;
                    break;
                case "aliyun":
                    window.location.href='hd/aliyun/aliyun_buy_hd.jsp?appname=' + newAppname;
            }
        }
    }
</script>