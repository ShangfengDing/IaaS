      ...
      <div class="modal-content">
         ...
         <div class="modal-body">  
				...
				<div class="row" style="margin-top: 20px">
					...
					<div id="slider_parent" class="col-md-10" style="padding-left: 26px;height:40px">
						...
						<div id="year-slider" class="front-slider noselect">
						    <input id="year-ex" style="width:80%" data-slider-handle="round" type="text" 
						...
						<div id="day-slider" class="front-slider noselect">
						    <input id="day-ex" style="width:80%" data-slider-handle="round" type="text" 
			...
			<div style="text-align:center">
				<div>已选择：<s:property value="diskDetail.Size"/>G硬盘,<span>共计</span><span class="slider-label" id="price"></span><span>元</span></div>				
			</div>
         </div>
         <div class="modal-footer" style="background-color:#f5f5f5;border-bottom-left-radius: 10px;
            ...
            <button type="button" class="btn btn-default" onclick="modalclear()">关闭</button>
			 <input id="continuAppName" type="hidden" value="<s:property value="appName"/>">
