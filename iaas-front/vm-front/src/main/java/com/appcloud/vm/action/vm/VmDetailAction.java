...
public class VmDetailAction extends BaseAction {
    ...
    public String execute() {
        logger.info(provider + regionId + instanceId + userEmail);
    ...
    private void showYunhaiDetails(Appkey appkey) {
        ...
        //用instanceId获得实例列表
        DescribeInstancesResponse instanceList = instanceClient.DescribeInstances(regionId.trim(),  com.appcloud.vm.common.Constants.ZONE_ID,
        ...
        //获得主机相关的硬盘
        DisksDetailReponse diskList = volumeClient.DescribeDisks(regionId.trim(), com.appcloud.vm.common.Constants.ZONE_ID, null,
...
//				TODO
            ...
            //查询快照
            SnapshotsDetailReponse snapshotsDetail = snapshotClient.DescribeSnapshot(regionId.trim(),  com.appcloud.vm.common.Constants.ZONE_ID,
...
//		TODO
    ...
    private void showAliyunDetails(Appkey appkey) {
        ...
        List<Instance> instanceList = aliInstanceClient.DescribeInstances(
                regionId.trim(), null, "[\"" + instanceId.trim() + "\"]", null, null, null,
        ...
        //获得主机相关的硬盘
        DescribeDisksResponse diskList = aliVolumeClient.DescribeDisks(regionId.trim(), null, null,
                instanceId.trim(), null, null, null, null, null, null, null, null, null,
                appkey.getAppkeyId(), appkey.getAppkeySecret(), appkey.getUserEmail());
