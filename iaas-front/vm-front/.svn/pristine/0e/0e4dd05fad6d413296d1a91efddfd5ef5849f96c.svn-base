...
public class NewImgAction extends BaseAction {
    ...
    private String zoneId =com.appcloud.vm.common.Constants.ZONE_ID;       //镜像所在的 ZoneID
    ...
    public String createYunHaiImage(Appkey appkey){
        CreateImageResponse createImageResponse = imageClient.createImage(regionId,null,null,serverId,volumeId,imageName,
