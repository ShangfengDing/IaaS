                                                    ...
                                                    <div class="front-toolbar other">
                                                        ...
                                                        <div id="provider" class="front-btn-group collapse">
                                                            <a class="btn btn-default front-no-box-shadow active"
                                                               id="#yunhai">云海</a>
                                                            <a class="btn btn-default front-no-box-shadow disabled" id="aliyun" onclick="window.location.href='vm/newvm/aliyun/newaliyunvm.jsp'">阿里云</a>
                                        ...
                                        <div class="panel-body front-last-no-margin">
                                            ...
                                            <div class="row hidden show-later" style="position: relative;margin-bottom:15px">
                                                ...
                                                <div style="margin-left: 40px">
                                                    已选择镜像:<p id="choosedImage" style="margin-left:15px;display: -webkit-inline-box"></p>
                                ...
                                <tr>
                                    ...
                                    <div class="panel panel-default front-panel card-gutter">
                                        ...
                                        <div class="panel-body front-last-no-margin">
                                            ...
                                            <div class="row hidden show-later" style="margin-top: 15px;margin-bottom: 15px">
                                                <div class="col-md-2">
                                    ...
                                    <div class="panel panel-default front-panel">
                                        ...
                                        <div class="panel-body front-last-no-margin">
                                            ...
                                            <div id="password-box">
                                                ...
                                                <div class="row" style="margin-bottom: 5px">
                                                    <div class="col-md-2">
                                                        <h5 class="label-pos2">root账户登录密码</h5>
                                                    </div>
                                                    <div class="col-md-4 col-sm-8">
