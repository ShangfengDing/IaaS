						...
						<s:property value="#diskDetail.status"/>
							<s:if test='diskDetail.status=="attached" || diskDetail.status=="In_use"'>
								...
								"<s:property value="diskDetail.providerEn"/>","<s:property value="userId"/>","<s:property value="appName"/>")'>
									<span class="glyphicon glyphicon-open"></span>&nbsp;卸载</a>
								...
								"<s:property value="userEmail"/>",
								"<s:property value="diskDetail.DiskId"/>",							
								"<s:property value="diskDetail.providerEn"/>","<s:property value="userId"/>","<s:property value="appName"/>")'><span class="glyphicon glyphicon-remove"></span>&nbsp;删除</a>
								</s:if>
								<s:else>
									<a class="btn btn-default front-no-box-shadow active"><span class="glyphicon glyphicon-remove"></span>&nbsp;删除</a>
								</s:else>
