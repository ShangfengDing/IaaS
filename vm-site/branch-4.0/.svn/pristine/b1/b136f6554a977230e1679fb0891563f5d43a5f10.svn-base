...
$(document).ready(function () {
    getAppname();        //changeAppName 是改变appname后引用的参数
    testWindowSize();
...
function changeName(i) {
    ...
    switch (provierEn) {
        case 'yunhai':
            window.location.href="vm/newvm/newyunhaivm.jsp?appname="+appName+"&&ulMenuName="+appName+"&&ulMenuProviderEn="+provierEn;
            break;
        case 'aliyun':
            window.location.href="vm/newvm/aliyun/newaliyunvm.jsp?appname="+appName+"&&ulMenuName="+appName+"&&ulMenuProviderEn="+provierEn;
            break;
    }
}
