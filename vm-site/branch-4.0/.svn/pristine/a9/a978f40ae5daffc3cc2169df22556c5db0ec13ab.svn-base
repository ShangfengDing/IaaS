...
<input type="hidden" id="zone" value="<s:property value="zone"/>" />
				 ...
				 <tr>
					<td class="col-sm-2">
                     ...
                     <td class="col-sm-1" style="padding-left:10px">
                             <label id="serverZone"><s:property value="#server.region"/></label>
                     </td>
                     <td class="col-sm-1" id="serverOsType"><s:property value="#server.zoneId"/></td>
                     <td class="col-sm-1">
                     	<div>
                     ...
                     <td class="col-sm-1" style="text-align: right">
                         <div class="btn-group">
                             ...
                             <a href='vm/vmdetail?provider=<s:property value="#server.providerEn"/>&appname=<s:property value="#server.appname"/>&regionId=<s:property value="#server.regionId"/>&instanceId=<s:property value="#server.instanceId"/>&userEmail=<s:property value="#server.userEmail"/>&zoneId=<s:property value="zone"/>'
