...
function applydisk() {
    ...
    switch (providerEn) {
        case 'yunhai':
            window.location.href="hd/newhd.jsp?menu=newhd&appname="+vmappname+"&&ulMenuName="+vmappname+"&&ulMenuProviderEn="+providerEn;
            break;
        case 'aliyun':
            window.location.href="hd/aliyun/aliyun_buy_hd.jsp?appname="+vmappname+"&&ulMenuName="+vmappname+"&&ulMenuProviderEn="+providerEn;
            break;
    }
}
