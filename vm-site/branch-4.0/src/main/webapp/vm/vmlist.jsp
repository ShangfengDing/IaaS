...
<div class="front-inner">
    <div class="container">
        ...
        <div class="col-md-12 form-group">
            ...
            <div class="col-md-2" style="padding-left: 0" id="zones">
            ...
            <div class="text-right col-md-8" style="padding-right: 0px">
                <a href="javascript:void(0)" onclick="refreshList()" class="btn btn-default"><span class="glyphicon glyphicon-refresh"></span> 刷新</a>
...
<script src="js/vm/vmdislistoperate.js"></script>   <!-- 主机列表获取appname和regionId -->
