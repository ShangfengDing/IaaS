...
<div class="modal-body">
    ...
    <br>
    <br>
    <button class="btn btn-primary" onclick="instanceTypeFamily_2_Modal.modal('hide')">确定</button>
    <button class="btn btn-default" onclick="instanceTypeFamily_2_Modal.modal('hide')">取消</button>
