...
public class Log {
    ...
    public static void INFO(Map<String, String> mapInfo, Appkey appkey, String regionId, String zoneId ) {
        mapInfo.put("infoType", "info");
        saveOperateLog(mapInfo, appkey, regionId,zoneId);
    }

    public static void ERROR(Map<String, String> mapInfo, Appkey appkey, String regionId, String zoneId) {
        mapInfo.put("infoType", "error");
        saveOperateLog(mapInfo, appkey, regionId,zoneId);
    }

    public static List<OperateLogItem> QueryLog(Map<String, String> mapInfo, Appkey appkey, String regionId, String zoneId) {
        ...
        logger.info("regionId=" + regionId +" zoneId" +zoneId);
        SearchOperateLogResponse searchOperateLogResponse = operateLogClient.searchOperateLogResponse(
                ...
                etime, btime, timeasc, size, regionId,zoneId, appkey.getAppkeyId(), appkey.getAppkeySecret());
        logger.info("查询操作日志：" +
                " result = " + result +
    ...
    public static void saveOperateLog(Map<String, String > mapInfo, Appkey appkey, String regionId, String zoneId) {
        String result = mapInfo.containsKey("result") ? mapInfo.get("result") : null;
        ...
        BaseResponse BaseResponse = operateLogClient.SaveOperateLog(result, userId,
                device, provider, operateType, deviceId, infoType, createdTime, regionId, zoneId, appkey.getAppkeyId(), appkey.getAppkeySecret());
        logger.info("保存操作日志：" +
                " result = " + result +
                " appkeyId = " + appkeyId +
                " userId = " + userId +
